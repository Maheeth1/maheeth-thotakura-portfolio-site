...
const ScrollAnimations = () => {
  ...
  return (
    <>
      {/* Scroll Progress Line - Separate from other animations with highest z-index */}
      <div
        className="fixed top-0 left-0 h-1 bg-gradient-to-r from-blue-500 to-purple-500 transition-all duration-300 ease-out z-[100]"
        style={{
